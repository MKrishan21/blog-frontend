      ...
      <div className="container py-10">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-3">
            <h3 className="text-lg font-semibold">Modern<span className="text-sky-500">Blog</span></h3>
            <p className="text-sm text-muted-foreground">
              A beautiful blog website with the latest news and articles on various topics.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/blog?category=technology" className="text-muted-foreground hover:text-primary">Technology</Link>
              </li>
              <li>
                <Link href="/blog?category=lifestyle" className="text-muted-foreground hover:text-primary">Lifestyle</Link>
              </li>
              <li>
                <Link href="/blog?category=business" className="text-muted-foreground hover:text-primary">Business</Link>
              </li>
              <li>
                <Link href="/blog?category=health" className="text-muted-foreground hover:text-primary">Health</Link>
              </li>
            </ul>
          </div>
